...
export class SimulatorResultCargoJoinController {
  constructor(private readonly simulatorResultCargoJoinService: SimulatorResultCargoJoinService) {}

  @Post()
  create(@Body() createSimulatorResultCargoJoinDto: CreateSimulatorResultCargoJoinDto) {
    return this.simulatorResultCargoJoinService.create(createSimulatorResultCargoJoinDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateSimulatorResultCargoJoinDto: UpdateSimulatorResultCargoJoinDto) {
    return this.simulatorResultCargoJoinService.update(+id, updateSimulatorResultCargoJoinDto);
  }
